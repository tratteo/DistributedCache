...
public class VirtualSynch {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("1 NODE JOINING");
    ...
    ActorRef joining2 = system.actorOf(VirtualSynchActor.props(manager, true), "vsnodeJ2");
    ...
    joining2.tell(new CrashMsg(CrashType.ChatMsg, 4), ActorRef.noSender());
    ...
    joining2.tell(new RecoveryMsg(), ActorRef.noSender());
    ...
    joining2.tell(new CrashMsg(CrashType.ChatMsg, 6), ActorRef.noSender());
